...
<body>
	...
	<nav id="menu">
		...
		<hr>
		<a class="title github-link" href="https://github.com/sylvainpolletvillard/ObjectModel" target="_blank" rel="noopener">
		...
		<div>
			...
			<ul>
				...
				<li><a href="#doc-sealed">Sealed models</a></li>
	...
	<div id="page">
		...
		<section id="introduction" class="grid">
			...
			<div class="description">
				...
				<p>ObjectModel intends to bring <strong>strong dynamic type checking</strong> to your web applications. Contrary to
					static type-checking solutions like <a href="https://www.typescriptlang.org" target="_blank" rel="noopener">TypeScript</a>
					or <a href="https://flowtype.org" target="_blank" rel="noopener">Flow</a>, ObjectModel can also validate data at
					runtime: JSON from the server, form inputs, content from local storages, external libraries...</p>

				<p>By leveraging <strong>ES6 Proxies</strong>, this library ensures that your variables always match the model
					definition and validation constraints you added to them. Thanks to the generated exceptions, it will help you spot
					potential bugs and save you time spent on debugging. ObjectModel is also very easy to master: no new language to
					learn, no new tools, no compilation step, just a minimalist and intuitive API in a plain old JS micro-library.</p>

				<p>Validating at runtime also brings many other benefits: you can define your own types, use them in complex model
					definitions with custom assertions that can even change depending on your application state. Actually it goes much
					further than just type safety. Go on and see for yourself.</p>
			</div>

			<div id="video-demo">
				<iframe data-src="https://www.youtube.com/embed/zmojfyNH_EE?rel=0&amp;showinfo=0" src="" width="640" height="360"
		...
		<section id="features-and-download" class="grid">
			<div id="features">
				...
				<ul>
					...
					<li>all in <strong class="size-gzip">4.03 KB</strong> minified and gzipped,
			...
			<div id="download">
				<h2>Download</h2>
				<h3>Current version: v<span class="version">3.7.6</span></h3>
				<ul>
					<li>From <a href="https://www.npmjs.com/package/objectmodel" target="_blank" rel="noopener">NPM</a> :
						<code>npm install objectmodel</code>
					</li>
					<li>From CDN: <a href="https://unpkg.com/objectmodel" rel="noopener">unpkg.com/objectmodel</a></li>
					<li>Minified bundle (<strong class="size-gzip">4.03 KB</strong> gzipped) :
						<a href="dist/object-model.min.js">object-model.min.js</a>
					</li>
					<li>Source files :
						<a class="link-zip" href="https://github.com/sylvainpolletvillard/ObjectModel/archive/v3.7.6.zip">object-model-3.7.6.zip</a>
					</li>
				</ul>
				...
				<p>Take a look at
					<a href="https://github.com/sylvainpolletvillard/ObjectModel/releases" target="_blank" rel="noopener">Github
						Releases</a>
					and <a href="#common-questions">Browsers/Node support</a> section for more information.
				</p>
			</div>
			...
			<div>
				...
				<p>Please report bugs on the
					<a href="https://github.com/sylvainpolletvillard/ObjectModel" target="_blank" rel="noopener">GitHub repository</a>.
				</p>
				<p>You can also ask for support on the
					<a href="https://gitter.im/sylvainpolletvillard/ObjectModel" target="_blank" rel="noopener">Gitter channel</a>.
				</p>
			</div>
		</section>
		...
		<section id="doc-basic-model" class="grid doc-code-code">
			<div class="doc">
				<h2>Basic models</h2>
				<p>Basic models simply validate a variable against the model definition passed as argument, and return the
					validated value. <code>BasicModel</code> constructor takes a <i>model definition</i> as the only argument. They
					are generally used to declare all the basic generic types that you will use in your application. You can find a
					list of <a href="#common-models">common basic models here</a>.</p>
			</div>
...
<code class="language-none exception">TypeError: expecting Number, got String "42"</code></pre>
		...
		<section id="doc-object-model" class="grid doc-code-code">
			<div class="doc">
				<h2>Object models</h2>
				<p>Object models validate nested object properties against a definition tree. They provide automatic validation at
					initial and future assignments of the properties of the instance objects.</p>
			</div>
...
<code class="language-none exception">TypeError: expecting product.quantity to be Number, got Boolean false</code></pre>
		...
		<section id="doc-model" class="grid doc-code">
			<div class="doc">
				...
				<p><code>Model</code> is the <strong>base class of all models</strong> and can be used as an alias for <code>BasicModel</code>
					and <code>ObjectModel</code> constructors.</p>
			</div>

			<div class="panel">
				<span class="legend">Example</span>
				<pre><code class="language-javascript">import { Model, BasicModel, ObjectModel } from "objectmodel" // if using npm, otherwise these are globals
...
<code class="language-javascript">console.log(rick.fullName); // "Rick Sanchez"</code></pre>
		...
		<section id="doc-optional-properties" class="grid doc-code-code">
			<div class="doc">
				...
				<p>By default, model properties are mandatory. That means all properties defined are required on instance
					declaration, otherwise an exception will be raised. But you can specify a property to be optional by using the
					bracket notation, borrowed from the JSDoc specification</p>
			</div>
...
<code class="language-none exception">TypeError: expecting email to be String, got undefined</code></pre>
		...
		<section id="doc-multiple-types" class="grid doc-code-code">
			<div class="doc">
				...
				<p>Several valid types can be specified for one property, aka union types. So optional properties are actually
					union types between the original type and the values <code>undefined</code> and <code>null</code>. To declare an
					optional union type, add <code>undefined</code> to the list.</p>
			</div>
...
<code class="language-none exception">TypeError: expecting easing to be Boolean or String or undefined, got Number 1</code></pre>
		...
		<section id="doc-value-checking" class="grid doc-code">
			<div class="doc">
				...
				<p>In model definitions, you can also specify values instead of types for model properties. The property value will
					have to match the model one. Just like union types, use brackets notation for value enumerations.</p>
	...
	color: ["black","white", new RegExp("^#([A-F0-9]{6})$"), undefined]
		...
		<section id="doc-null-safe" class="grid doc-code-code">
			<div class="doc">
				...
				<p>When you want to traverse nested objects, you always have to worry about the null pointer exception. Some
					languages such as Groovy have a safe navigation operator represented by <code>?.</code> to safely navigate through
					potential null references. In JavaScript, there is no such solution so you have to manually check for <code>undefined/null</code>
					values at each level of the object. But within an object model, declared properties are null-safe for traversal:
					every instance complete its structure with undefined properties according to the model definition.</p>
			</div>
...
// model_config.local.time.format returns undefined</code></pre>
		...
		<section id="doc-default-values" class="grid doc-code-code">
			<div class="doc">
				...
				<p>You can set a default value for any model with <code>model.defaultTo(value)</code>. This default value will be
					used if the argument passed to the model constructor is undefined.</p>
			</div>
			...
			<div class="doc">
				<p>To specify default values for some properties of your object models, put them in the model prototype. You can
					also use the <code>defaults</code> method as a shorthand for setting all the default values at once. If these are
					not defined at object instanciation, their default value will be assigned.</p>
			</div>
...
<code class="language-none log">["name","size","creationDate","writable"]</code></pre>
		...
		<section id="doc-composition" class="grid doc-code-code">
			<div class="doc">
				...
				<p>Models declared can also be used for type checking, so you can compose structures of models. Note that the
					property values do not necessarily need to be model instances to be considered valid: only the definition of the
					associated model must be respected. This is called <a href="http://en.wikipedia.org/wiki/Duck_typing" target="_blank"
					 rel="noopener">duck typing</a>, which can be summarized as <i>"If it looks like a duck and quacks like a duck,
						then it's a duck"</i>.</p>
				<p>When a model definition is recognized, the value is automatically replaced by an instance of the corresponding
					model. This naive approach is very time saving and allows you, for example, to parse composed models from JSON in
					one step. If there is somehow an ambiguity (such as two possible valid models within an union type), the value is
					kept unchanged and a warning console message will inform you how to solve this ambiguity.</p>
			</div>
...
couple.husband instanceof Person === true // object has been casted to Person</code></pre>
		...
		<section id="doc-extensions" class="grid doc-code-code">
			<div class="doc">
				...
				<p>Extensions create new models based on existing model definitions. You can declare new properties or override
					previous ones. Therefore, it is an easy way to reproduce subtyping and class inheritance.</p>
			</div>
...
expecting child to be {
	...
	female: Boolean
			...
			<div class="doc">
				...
				<p>Extended models inherit the parent's prototype chain, so you can easily combine it with class inheritance. Just
					make sure to respect the <a href="https://en.wikipedia.org/wiki/Liskov_substitution_principle" target="_blank" rel="noopener">Liskov
						substitution principle</a> when you extend a type definition.</p>
			</div>
...
<code class="language-none log">Joanna</code></pre>
		...
		<section id="doc-multiple-inheritance" class="grid doc-code-code">
			<div class="doc">
				...
				<p>But it goes further: you can do multiple inheritance and mix any number of parent models definitions and
					assertions. If some properties have the same name, those of the last object overrides the others.</p>
			</div>
...
<code class="language-none log">joe@email.net: Dear Joe, thank you for ordering 100 diapers on daddy.net</code></pre>
		...
		<section id="doc-sealed" class="grid doc-code-code">
			<div class="doc">
				<h2>Sealed object models</h2>
				<p>By default, an object with properties not declared in the definition is still valid, as long as the rest of the
					definition is respected. This is an intended behaviour to enable model extensions and respect the <a href="https://en.wikipedia.org/wiki/Liskov_substitution_principle"
					 target="_blank" rel="noopener">Liskov substitution principle</a>. Also, some frameworks and libraries add their
					own private properties to your data, and blocking them would prevent these tools from working properly.</p>
				<p>However, if you really want to prevent all undeclared properties, you can set the <code>model.sealed</code>
					property to <code>true</code>. This is the equivalent of <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/seal"
					 target="_blank" rel="noopener"><code>Object.seal()</code></a> but for object models instances. The undeclared
					props will be catched on initial and future assignments</p>
			</div>

			<div class="panel panel1">
				<span class="legend">Model</span>
				<pre><code class="language-javascript">const Package = ObjectModel({
	name: String,
...
// or Package.sealed = true
			...
			<div class="panel panel2">
				<span class="legend">Instance</span>
				<pre><code class="language-javascript">const Foo = new Package({ name: "foo", _id: 1 });</code>
<code class="language-none exception">TypeError: property _id is not declared in the sealed model definition</code>
<code class="language-javascript">const Bar = new Package({ name: "bar" });
Bar.config.hack = true;</code>
<code class="language-none exception">TypeError: property config.hack is not declared in the sealed model definition</code>
<code class="language-javascript">Package.sealed = false;
Bar.config.hack = true; // no more exceptions thrown</code></pre>
			</div>
		</section>
		...
		<section id="doc-assertions" class="grid doc-code-code">
			<div class="doc">
				...
				<p>You can add to your models any number of assertions that are custom test functions applied on model instances.
					All assertions are called every time the model is changed, and must all return <code>true</code> to validate.
					Exceptions thrown in assertions are catched and considered as assertion failures.</p>
				<p>For example, we can get an Integer model by adding <code>Number.isInteger</code> as an assertion to a basic
					<code>Number</code> model.</p>
				<p>Assertions are inherited from the model prototype, so you can add global assertions on all models by setting
					them in <code>Model.prototype</code>. The second argument of the <code>assert</code> method is an optional message
					shown when assertion fails. It can be a String or a function returning a String.</p>
			</div>
...
<code class="language-none exception">TypeError: assertion isPrime returned false for value 87</code></pre>
		...
		<section id="doc-private-and-constants" class="grid doc-code-code">
			<div class="doc">
				...
				<p>Some variable naming conventions are commonly used in JavaScript. For example, a leading underscore is used to
					specify
					a
					<i>_private</i> property which should not be used outside the object own methods. Also, constants are often in
					<i>ALL_CAPS</i>. Model definitions follow these conventions by making
					<i>_underscored</i> properties not enumerable and not usable outside of the instance's own methods, and
					<i>CAPITALIZED</i> properties not writable.
				</p>
				<p>Note: private properties access is granted only when using the instance own methods. Methods declared in an
					extended class cannot access to privates. Asynchronous callbacks do not work neither,
					except if these callbacks are defined as methods of the model. If this does not fit your usecase, you should
					probably not make these properties private.
				</p>
			</div>
...
<code class="language-none log">3 "cm"</code></pre>
		...
		<section id="doc-array-model" class="grid doc-code-code">
			<div class="doc">
				...
				<p>The validation is done on initial array elements passed to the model, then on new elements added or modified
					afterwards.</p>
			</div>
...
<code class="language-none exception">TypeError: assertion "should have two cards" returned false for value [7, "Joker", "K"]</code></pre>
			...
			<div class="doc">
				<p>All the validation options for previous models are also available for array model elements: type/value checking,
					optional properties, union types, enumerations, assertions...</p>
			</div>
...
<code class="language-none exception">TypeError: expecting Array[1] to be { name: String, female: Boolean }, got String "dog"</code>
		...
		<section id="doc-function-model" class="grid doc-code-code">
			<div class="doc">
				...
				<p>Function models provide validation on input (arguments) and output (return value). All the validation options
					for Object models are also available for Function models. The arguments passed to <code>FunctionModel</code> are
					the types of the arguments the function will receive, and the <code> return</code> method is used to specify the
...
<code class="language-none exception">TypeError: assertion "isFinite" returned false for value Infinity</code></pre>
			...
			<div class="doc">
				<p>In classical JavaScript OOP programming, methods are declared in the constructor's <code>prototype</code>. You
					can do the same with instances of function models. Another option is to provide a default implementation in the
					model definition by using the <code>defaults</code> method. <a href="#doc-default-values">See the 'Default values'
						section</a>. The difference is that all the properties in the model definition are required for an object to be
					considered suitable for the model. In the following example, an object must have a function <code>sayMyName</code>
					to be valid as a Person, while the function <code>greet</code> is not mandatory.</p>
			</div>
...
<code class="language-none exception">TypeError: expecting arguments[0].sayMyName to be "Function", got String "woof !"</code></pre>
		...
		<section id="doc-map-models" class="grid doc-code-code">
			<div class="doc">
				<h2>Map models</h2>
				<p>Map models validate ES6 <code>Map</code> objects by checking both keys and values. The arguments passed to <code>MapModel</code>
					are respectively the definition for the keys and the definition for the values.</p>
			</div>
...
<code class="language-none exception">TypeError: expecting Map["history"] to be "A" or "B" or "C" , got String "nope"</code></pre>
		...
		<section id="doc-set-models" class="grid doc-code-code">
			<div class="doc">
				<h2>Set models</h2>
				<p>Set models validate ES6 <code>Set</code> objects by checking the type of all the elements in the set. The API is
					the same as array models.</p>
			</div>
...
<code class="language-none exception">TypeError: expecting Set value to be "math" or "english" or "history", got String "sleeping"</code></pre>
		...
		<section id="doc-custom-collectors" class="grid doc-code-code">
			...
			<div class="doc">
				<p>By default, validation errors are collected every time a model instance is created or modified, and thrown as
					<code>TypeError</code> exceptions with a message describing all the errors found. It it possible to change this
					behaviour and add your own error collectors. For example, you may want to notify the user that an error occurred,
					or send the information to your server for error tracking on production.</p>
			</div>
			<div class="doc">
				<p>Error collectors are callback functions called with an array of all the errors collected during the last model
					inspection. Every error is an object with these properties:</p>
				<ul>
				...
				<pre><code class="language-none log">This specific error collector caught these errors:
{
	...
	received: "cheating"
		...
		<section id="doc-custom-devtool-formatters">
			...
			<p>ObjectModel provides custom formatters for Models and Model instances in Chrome Developer Tools, available in
				Chrome and Opera. These formatters improve the way models and instances are displayed when logged in the console.</p>

			<h3>Enabling custom formatters</h3>

			<p>Chrome currently doesn’t have custom formatters enabled by default. You need to enter the DevTools settings via
				the menu at the top right of the DevTools panel, then select <i>Preferences</i> and check <i>Enable custom
					formatters</i> in the <i>Console</i> section.</p>
			...
			<p>The formatters for ObjectModel are <strong>included by default in the unminified bundle (<code>dist/object-model.js</code>)</strong>.
			...
			<p>A variable name is irrelevant to name a Model, because several variables with different names can point to the
				same Model reference. To specify a unique model name for debugging purposes, you can use the <code>as()</code>
				method like this :</p>
...
console.log(Integer.name) // "Integer"</code></pre>
		...
		<section id="api">
			...
			<dl>
				<dt><a href="#doc-model">Model</a> <code>Model(definition, params)</code></dt>
				...
				<dt><a href="#doc-object-model">ObjectModel</a> <code>ObjectModel(definition, params)</code></dt>
			...
			<dl>
				...
				<dd>Manually triggers the validation of a model instance over its definition.
					...
					<br>
					Note that contrary to the <code>test</code> method, the object is not cast to its suitable model
					(a.k.a <a href="#doc-composition">duck typing</a>) before being validated.
				</dd>

				<dt><a href="#doc-private-and-constants">conventionForConstant</a> <code>function(variableName)</code></dt>
				<dd>Internal function used to identify a constant property based on naming convention. You can override it to suit
					your needs.</dd>

				<dt><a href="#doc-private-and-constants">conventionForPrivate</a> <code>function(variableName)</code></dt>
				<dd>Internal function used to identify a non-enumerable property based on naming convention. You can override it to
					suit your needs.</dd>
			...
			<dl>
				...
				<dt>sealed <code>objectModel.sealed = true</code></dt>
				<dd>If set to <code>true</code>, undeclared properties will be forbidden for this model. Can also be set on <code>Model.prototype</code>.<br>By
					default, additional properties are tolerated in order to allow model extensions.</dd>
			</dl>
			<h3>Function models</h3>
			<dl>
				<dt>return <code>functionModel.return(returnValueDefinition)</code></dt>
				<dd>Set the definition of the return value. Each call to the function must return a validated value, otherwise an
		...
		<section id="common-models">
			...
			<p>Here are some models that you may find useful. <strong>These are not included in the library</strong>, so pick
				what you need or <a href="examples/common.js">get them all from here</a></p>
		...
		<section id="common-questions">
			...
			<details>
				...
				<p>This library is <a href="test/" target="_blank">unit tested</a> against these browsers and Node.js versions,
					depending of the version of Object Model:</p>
				<dl>
					...
					<dd>Support for IE < 11 had to be dropped in v2 because it required many hacks and was holding back other
						 browsers. Otherwise, same support than v1.</dd> <dt>v3.x</dt>
					<dd>ObjectModel v3 is built around ES6 Proxies, so requires modern environments : Edge 14+, Firefox 47+, Chrome
						50+, Safari 10+, Node 6.0+.</dd>
				</dl>
			</details>

			<details>
				<summary>What is the impact on performance ?</summary>
				<p>To get dynamic type validation, Object models have to override properties setters so that each assignment passes
					through a function that acts as a proxy. This has a cost, especially on old browsers. Therefore, it is not
					advisable to use object models in performance-critical parts of your applications. In particular, Array models and
					circular references in models have the most impact on performance. But in general, the loss of time does not
					exceed a few milliseconds and is quite negligible.</p>
			</details>
			...
			<details>
				...
				<div class="grid doc-code">
					<div class="doc">
						<p>With the <code>constructor</code> property. If this property is used in your model, you can also retrieve it
							with <code>Object.getPrototypeOf(instance).constructor</code>. This is useful for retrieving the type of a
...
// modelOfJoe.definition.name === String</code></pre>
			...
			<details>
				...
				<div class="grid doc-code">
					<div class="doc">
						<p>The recommended way is to use a factory function to instanciate your models. You can declare as many different
							factories as needed, which makes this pattern both simple and flexible.</p>
					</div>
					<div class="panel">
						<pre><code class="language-javascript">const User = ObjectModel({
    firstName: String,
...
const joe = User.create({ firstName: "Joe", lastName: "Dalton" });</code></pre>
			...
			<details>
				...
				<div class="grid doc-code">
					<div class="doc">
						<p>You can't refer to a model or instance that is not yet defined, so you have to update the definition
							afterwards:</p>
					</div>
					<div class="panel">
...
joe.sweetie = ann;</code></pre>
			...
			<details>
				...
				<div class="grid doc-code-code">
					<div class="doc">
						<p>Serializing in JSON necessarily implies that you lose the type information, except if you store it manually
							with your data, then retrieve it with a custom parsing function. It is for the best to let you decide how you
							want to store the type information within your data.</p>
...
console.log(
	...
	b.items[1] instanceof Type2
			...
			<details>
				...
				<p>Models have been designed to use all the advantages of runtime validation, such as complex assertions, mixed
					value/type checking or custom error collectors. Compared to static type systems, the feature set is really
					different. I suggest you to combine the strengths of static and dynamic type-checking: use static annotations in
					your business logic layer, and Models at your API boundaries to validate user input, network responses or
					serialized data. You can also use both at the same place as demonstrated in the introduction video.</p>
				<p>If you are looking for a runtime type-checking solution that acts as a fully transparent layer over an existing
					static type system, you should try <a href="https://codemix.github.io/flow-runtime/" target="_blank" rel="noopener">flow-runtime</a>
					instead.</p>
			</details>
			...
			<details>
				...
				<div class="grid doc-code-code">
					<div class="doc">
						<p>It is impossible to validate both the Promise and the resolved value at the same time, because of its
							asynchronous nature. So it actually requires two different models: a first one to check if it is actually a
							Promise, then a second one to validate the emitted value once the promise is resolved. See <a href="https://github.com/sylvainpolletvillard/ObjectModel/issues/88"
							 target="_blank" rel="noopener">this issue</a> for details.</p>
					</div>
   ...
   // ObjectModel has validated both the Promise and the resolved value
		...
		<section>
			...
			<p>Please check the documentation twice, then open an issue on the
				<a href="https://github.com/sylvainpolletvillard/ObjectModel/issues" target="_blank" rel="noopener">Github
					repository</a>
			</p>
		</section>
			...
			<ul class="share-buttons">
				<li>
					<a href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fobjectmodel.js.org&t=ObjectModel%3A%20Model%20Definition%20and%20Runtime%20Type%20Checking%20for%20JavaScript"
					 title="Share on Facebook" target="_blank" rel="noopener" onclick="window.open(this.href); return false;">
				...
				<li>
					<a href="https://plus.google.com/share?url=http%3A%2F%2Fobjectmodel.js.org" target="_blank" title="Share on Google+"
					 onclick="window.open(this.href); return false;">
						<img class="lazy" data-src="docs/res/googleplus.svg" width="48" height="48">
					</a>
				</li>
				<li>
					<a href="https://gitter.im/sylvainpolletvillard/ObjectModel?utm_source=website" target="_blank" rel="noopener"
